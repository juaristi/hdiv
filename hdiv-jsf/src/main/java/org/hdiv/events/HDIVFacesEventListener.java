 ...
 * </p>
 * <p>
 * Implementa el interfaz StateHolder para marcarlo como transient y que no se guarde en el estado de JSF. Implements
 * StateHolder interface to set it as transient and don't store it in HDIV state.
 * </p>
 * 
...
public class HDIVFacesEventListener implements FacesListener, StateHolder {
	 ...
	 *            request context
	 */
	private void log(ValidationError error, FacesContext facesContext) {
