...
public class UtilsJsf {
	...
	private static List<String> JSFImplementationParamNames = null;
	...
	public static List<String> getJSFImplementationParamNames(String submitedFormClientId) {
		...
		if (JSFImplementationParamNames != null) {
			return JSFImplementationParamNames;
		}
		...
		JSFImplementationParamNames = list;
	 ...
	 * 
	 * @param component
	 *            {@link UIOutcomeTarget} component
